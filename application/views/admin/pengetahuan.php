      ...
      <tr>
        ...
        <td><?php echo $p['cf_pakar'] ?></td>
          <td style="text-align: center;"><button class="btn btn-warning update glyphicon glyphicon-repeat" data-toggle="modal" data-target="#modal-edit<?php echo $p['id_pengetahuan']?>">Edit</button>
             <button class="btn btn-danger glyphicon glyphicon-remove-sign" data-toggle="modal" data-target="#modal-hapus<?php echo $p['id_pengetahuan']?>" >Hapus   </button></td>
...
<div class="modal fade" id="modal-tambah">
  ...
  <div class="form-msg"></div>
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
  <h3 style="display:block; text-align:center;">Tambah Data Basis Pengetahuan</h3>
